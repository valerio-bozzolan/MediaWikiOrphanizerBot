...
{{Conteggio cancellazioni/In corso/Voce|i = 1 |voce = ASD |turno = 2 |tipo = votazione |data = 2018 maggio 3 |multipla = 1 |temperatura = 42 }}

<!-- START TEMPLATE -->
{{Conteggio cancellazioni/In corso/Voce|i = %5$d |voce = %1$s |turno = %10$s |tipo = %6$s |data = %9$s |multipla = %3$s |temperatura = %2$d }}
