...
/**
 * Handle a daily prolonged PDC category
 *
 * e.g. https://it.wikipedia.org/wiki/Categoria:Cancellazioni_consensuali_prorogate_del_11_aprile_2018
 */
class CategoryYearMonthDayTypeProlonged extends CategoryYearMonthDayType {
	 ...
	 */
	const PDC_TYPE_HUMAN = 'consensuale prorogata';
}
